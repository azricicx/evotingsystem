        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                    <label for="voter_id" class="col-sm-3 control-label">Student ID</label>
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="voters_edit.php">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="edit_lastname" name="voters_id">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="edit_password" class="col-sm-3 control-label">Current Voter Password</label>
